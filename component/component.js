		 ...
		 */
		{
				...
				if (can.Component) {
					...
					this.Control = can.Control.extend({
						...
						setup: function (el, options) {
							...
							var self = this;
							this.on(this.scope, "change", function onScopeChange() {
								self.on();
								self.on(self.scope, "change", onScopeChange);
							});
							return res;
						}
			...
			setup: function (el, hookupOptions) {
				...
				if (this.constructor.renderer) {
					...
					helpers._tags.content = function contentRendered(el, rendererOptions) {
						...
						if (subtemplate) {
							...
							helpers._tags.content = contentRendered;
						}
					};
